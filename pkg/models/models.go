...
// Tenant represents a multi-tenant isolation unit in Auth Pole.
type Tenant struct {
	ID        string    `json:"id"`
...
// SigningKey represents asymmetric key pair used for signing Auth Pole JWT tokens per tenant/app.
